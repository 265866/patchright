...
import { removeFolders, sanitizeForFilePath } from 'patchright-core/lib/utils';
import { ManualPromise, calculateSha1, createGuid, getUserAgent } from 'patchright-core/lib/utils';
