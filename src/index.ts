...
import * as playwrightLibrary from 'patchright-core';
import { setBoxedStackPrefixes, createGuid, currentZone, debugMode, jsonStringifyForceASCII, asLocatorDescription, renderTitleForCall, getActionGroup, escapeHTML } from 'patchright-core/lib/utils';
...
import type { ClientInstrumentationListener } from '../../patchright-core/src/client/clientInstrumentation';
import type { Playwright as PlaywrightImpl } from '../../patchright-core/src/client/playwright';
import type { Browser as BrowserImpl } from '../../patchright-core/src/client/browser';
import type { BrowserContext as BrowserContextImpl } from '../../patchright-core/src/client/browserContext';
import type { APIRequestContext as APIRequestContextImpl, NewContextOptions as APIRequestContextOptions } from '../../patchright-core/src/client/fetch';
import type { ChannelOwner } from '../../patchright-core/src/client/channelOwner';
import type { Page as PageImpl } from '../../patchright-core/src/client/page';
import type { BrowserContext, BrowserContextOptions, LaunchOptions, Page, Tracing } from 'patchright-core';
